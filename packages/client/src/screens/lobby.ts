...
export function showLobby(opts: LobbyOptions): { dispose(): void } {
  ...
  root.innerHTML = `
    <div class="card">
      ...
      <div class="error"></div>
      <div class="help">WASD move · Space jump · Mouse aim · LMB attack · 1/2 or wheel switch weapon · Tab scoreboard.
  ...
  createBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      if (testMs > 0) options.testOverrides = { durationMs: testMs, respawnMs: 1000 };
